...
```
	...
	wget https://github.com/hermes-ci/hermes/archive/v1.0.1-beta.tar.gz
	tar -xzvf v1.0.0-beta.tar.gz
    sudo chmod +x hermes-1.0.1-beta/hermes.sh
	sudo hermes-1.0.1-beta/hermes.sh install
```
### Installation RHEL/Fedora
```
	sudo yum install jq git
	wget https://github.com/hermes-ci/hermes/archive/v1.0.1-beta.tar.gz
	tar -xzvf v1.0.1-beta.tar.gz
    sudo chmod +x hermes-1.0.1-beta/hermes.sh
	sudo hermes-1.0.1-beta/hermes.sh install
```
