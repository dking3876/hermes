...
```
	...
	wget https://github.com/hermes-ci/hermes/archive/v1.0.2-beta.tar.gz
	tar -xzvf v1.0.2-beta.tar.gz
    sudo chmod +x hermes-1.0.2-beta/hermes.sh
	sudo hermes-1.0.2-beta/hermes.sh install
```
